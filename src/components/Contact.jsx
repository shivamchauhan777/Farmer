    ...
    return (
        <>
            <form onSubmit={handleSubmit(onsubmit)}
             className="sm:h-[100vh] w-full flex flex-col justify-start gap-20 items-center pb-5 bg-gray-900">
                ...
                <div className=" w-[90vw]  xl:w-[55vw]  border-2    text-white  text-start px-5 py-10 rounded-3xl flex flex-col sm:flex-row transition duration 700 " >
                    ...
                    <div className="mt-5 md:mt-0 md:px-5 md:w-[55%] ">
                        ...
                        <input type="text" className="w-[95%] md:w-full h-[40px] rounded-lg bg-white  text-black px-2 outline-none " 
                        ...
                        <input type="email" className="w-[95%] md:w-full *: h-[40px] rounded-lg bg-white   text-black px-2  outline-none border border-black  "
                        ...
                        <textarea type="text" id='message' className="w-[95%] md:w-full h-[100px] rounded-lg bg-white text-black px-2  outline-none border border-black "
                        ...
                        <input className="cursor-pointer w-[95%] sm:w-[100%] h-[40px] mt-5 rounded-lg bg-green-500 text-white  text-lg  p-2" type='Submit' 
